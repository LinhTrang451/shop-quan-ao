<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="update.aspx.cs" Inherits="SE1436_Group4_Assigment.update" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table style="width:100%;">
        ...
        <tr>
            ...
            <td>
                <asp:Image CssClass="image" ID="txtImage"  runat="server" Visible="False" />
            </td>
            <td>
               &nbsp
            </td>
